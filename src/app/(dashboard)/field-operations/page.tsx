...
export const metadata = {
  title: "Field Operations — SyncVet",
  description:
    "Barangay-level field vaccination drives and mobile team deployment for the CDO Veterinary Office.",
};
  ...
  return (
    <div className="flex-1 space-y-4 p-6 pt-6 bg-background min-h-screen text-foreground">
      <PageHeader
        ...
        subtitle={
          <>
            Barangay-level <span className="text-foreground">field vaccination drives</span> and mobile team deployment with{" "}
            <span className="text-foreground">offline-first data capture</span>.
          </>
        }
        actions={
      ...
      <Card>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription className="text-[11px] text-muted-foreground/60">
                Scheduled, active, and completed field vaccination drives across CDO barangays
              </CardDescription>
            </div>
            <div className="flex items-center gap-3">
              <div className="relative">
                <Search className="absolute left-2.5 top-1/2 size-3.5 -translate-y-1/2 text-muted-foreground" />
                <Input placeholder="Search by barangay or team..." className="h-8 w-64 pl-8 text-xs" />
              </div>
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-[10px] font-bold uppercase tracking-widest">Op ID</TableHead>

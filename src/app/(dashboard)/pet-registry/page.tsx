...
const allPets = [
  ...
  { id: "CDO-2026-00134", name: "Choco", species: "Dog", breed: "Aspin (Mixed)", owner: "Liza Fernandez", barangay: "Lapasan", vaccinated: true, qr: true },
  { id: "CDO-2026-00133", name: "Kitty", species: "Cat", breed: "Persian Mix", owner: "Aaron Villarin", barangay: "Carmen", vaccinated: true, qr: true },
  { id: "CDO-2026-00132", name: "Max", species: "Dog", breed: "Golden Retriever", owner: "Patricia Dela Rosa", barangay: "Bulua", vaccinated: true, qr: true },
  { id: "CDO-2026-00131", name: "Luna", species: "Cat", breed: "Calico", owner: "Rico Tan", barangay: "Macasandig", vaccinated: false, qr: false },
];
    ...
    <div className="flex-1 space-y-4 p-6 pt-6 bg-background min-h-screen text-foreground">
      ...
      <Card>
        ...
        <CardContent className="px-0">
          ...
          <TablePagination page={safePage} totalPages={totalPages} pageSize={pageSize} totalItems={filtered.length} itemLabel="pets" onPageChange={setPage} onPageSizeChange={(s) => { setPageSize(s); setPage(1); }} />
        </CardContent>
      </Card>
    </div>
  );
